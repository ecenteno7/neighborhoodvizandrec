...
def get_gmaps_info(apikey, lat, lon, city, neighborhoods_file):
    ...
    for search_type in place_types_all:
        search_results = gmaps.places_nearby(location=(lat, lon), radius=100, type=search_type)
...
def characterize_city(city):
    ...
    place_types_testing1 = ["bar", "beauty_salon", "cafe", "gym", "library", "liquor_store", "lodging", "meal_delivery", "meal_takeaway", "movie_theater","museum", "night_club", "park", "restaurant", "school", "shoe_store", "shopping_mall", "spa","store", "subway_station", "supermarket","tourist_attraction", "train_station", "transit_station", "zoo"]
    place_types_testing2 = ["bar", "museum", "night_club", "restaurant", "store", "supermarket","tourist_attraction","transit_station"]
    ...
    for feature in neighborhoods['features']:
        ...
        n_details['name'] = {'name':feature['properties']['name'], "counts":{}}
        ...
        n_polygon = n_polygon.simplify(tolerance=0.0001, preserve_topology=True)
        ...
        for search_type in place_types_testing2:
            ...
            search_results = gmaps.places_nearby(location=(lat, lon), radius=max_distance, type=search_type)
